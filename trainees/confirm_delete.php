...
if(isset($_POST['delete']) && count($_POST['id']) > 0){
    ...
    $stm = $pdo->query("SELECT * FROM trainees WHERE id IN ($ids)");
    $trns = $stm->fetchAll();
            ...
            <div class="col-md-6 offset-md-3">
                <div class="card bg-warning">
                    ...
                    <div class="card-body">
                        ...
                        <ul>
                            <?php foreach($trns as $trn): ?>
                                <li>User ID - <?= $trn->user_id ?> , Course ID - <?= $trn->course_id ?> </li>
                        ...
                        <a href="../trainees/index.php" class="btn btn-info btn-sm">Cancel</a>
                        </form>
                    </div>
                </div>
            </div>
