...
if(isset($_POST['delete']) && count($_POST['id']) > 0){
    ...
    $stm = $pdo->query("SELECT * FROM trainors WHERE id IN ($ids)");
    $trainor = $stm->fetchAll();
        ...
        <div class="row">
            <div class="col-md-6 offset-md-3">
                <div class="card bg-warning">
                    ...
                    <div class="card-body">
                        <h4>Are you sure you want to delete this Trainor?</h4>
                        <form action="../trainors/process_delete.php" method="post">
                        <ul>
                            <?php foreach($trainor as $t): ?>
                                <li><?= $t->user_id ?> - <?= $t->specialty ?> </li>
                        ...
                        <a href="../trainors/index.php" class="btn btn-info btn-sm">Cancel</a>
                        </form>
                    </div>
                </div>
            </div>
